...
import (
	...
	"github.com/wukongcloud/netcap/dbdata"
	"github.com/wukongcloud/netcap/sessdata"
...
func (p *AuditPayload) Add(userName string, pl *sessdata.Payload) {
	...
	default:
		putPayload(pl)
		fmt.Println("AccessAudit: AuditPayload channel is full")
	}
}
...
func LogAudit(userName string, pl *sessdata.Payload) {
	...
	if ok && nu-v.(int64) < int64(AuditInterval) {
		// 回收byte对象
		putByte51(b)
		return
	}
	...
	default:
		fmt.Println("AccessAudit: LogChan channel is full")
		return
	}
}
